...
public class Bullet extends Projectile {
    ...
    public Bullet(int d, int r, ImageView src,int level) {
        ...
        if (level == 1) {
            ...
            super.getImg().setScaleX(0.5);
            super.getImg().setScaleY(0.5);
        }
        else if (level == 2) {
            ...
            super.getImg().setScaleY(0.6);
            super.getImg().setScaleX(0.6);
        }
    ...
    AnimationTimer collisionTimer = new AnimationTimer() {
        ...
        public void handle(long l) {
            for (Alien al : GameController.gc.getAliens()) {
                if (Bullet.super.getImg().getBoundsInParent().intersects(al.getImg().getBoundsInParent())) {
